...
('Debian', 'debian', 'os', 'Debian — стабильный дистрибутив Linux', 'debian', 'bookworm', 'debian', '{"ports":[],"env":[],"volumes":[],"cmd":"/bin/bash","cpu":"1","ram":"512m","restart":"unless-stopped"}', 2),
('Alpine', 'alpine', 'os', 'Alpine Linux — минималистичный дистрибутив (5 MB)', 'alpine', 'latest', 'alpine', '{"ports":[],"env":[],"volumes":[],"cmd":"/bin/sh","cpu":"0.5","ram":"128m","restart":"unless-stopped"}', 3),
('CentOS', 'centos', 'os', 'CentOS Stream — корпоративный Linux', 'centos', 'stream9', 'centos', '{"ports":[],"env":[],"volumes":[],"cmd":"/bin/bash","cpu":"1","ram":"512m","restart":"unless-stopped"}', 4),
('Rocky Linux', 'rocky', 'os', 'Rocky Linux — стабильная замена CentOS', 'rockylinux', '9', 'linux', '{"ports":[],"env":[],"volumes":[],"cmd":"/bin/bash","cpu":"1","ram":"512m","restart":"unless-stopped"}', 5);
